        ...
        ?>
         <form action="" method="post" enctype="multipart/form-data">
		  ...
		  <tr>
                    ...
                    <td>
                        <textarea class="tinymce" value = "" name ="body"><?php echo $value['body'];?></textarea>
                    </td>
                </tr>
		<tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <img src="<?php echo $value['image'];?>" height="100" width="100">
		...
		<tr>
                    ...
                    <td>
                        <select id="select" name="type">
                            ...
                            <?php
                                if ($value['type'] == 0){ ?>
                                    <option selected = "Featured" value="0">Featured</option>
                                    <option value="1">General</option>
                            <?php } else {?>              
                                    <option selected = "Featured" value="1">General</option>
